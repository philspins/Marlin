...
#define CUSTOM_MACHINE_NAME "Phil's TNSE3P (Marlin v2.1.2)"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 408, 137 }
 ...
 * 
 *  - BTT SKR MINI E3 V2.0 appears to use PC14 according to this diagram:
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -19, -2.35 }
